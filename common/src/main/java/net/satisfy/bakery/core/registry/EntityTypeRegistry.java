...
public class EntityTypeRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<CabinetBlockEntity>> CABINET_BLOCK_ENTITY = registerBlockEntity("cabinet", () -> BlockEntityType.Builder.of(net.satisfy.bakery.core.block.entity.CabinetBlockEntity::new, addCabinet(new HashSet<>()).toArray(new Block[0])).build(null));
